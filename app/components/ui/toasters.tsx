  ...
  return toast(
    (t) => (
      <div className="flex flex-col gap-2">
        ...
        <span className="font-nunito text-slate-900 -mt-1 text-sm">
          {message}
        </span>
      </div>
    ),
    {
      id: "error-toast",
      className: "border-b-[6px] border-red-500 bg-red-100 !rounded-2xl",
    }
  );
};
export const successToast = (title: string, message: string) => {
  return toast(
    ...
    {
      id: "error-toast",
      className: "border-b-[6px] border-green-500 bg-green-100 !rounded-2xl",
    }
  );
};
