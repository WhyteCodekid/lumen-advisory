  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="h-screen w-full backdrop-blur-sm bg-black/50 fixed top-0 left-0 z-50 flex items-center justify-center"
      >
        <motion.svg
          ...
          height="1em"
          viewBox="0 0 24 24"
          className="text-amber-500 text-3xl xl:text-7xl"
